...
;(function(global, $){
	...
	function updateRowEvents ($element, type)
	{
		...
		//since we are using a transparent element to block all
		//interaction, this is no longer needed and actually screws with things
		/*$(".element_wrapper", $composer).disableSelection().

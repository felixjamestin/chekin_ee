...
$config['debug'] = "1";
$config['cp_url'] = "http://chekin.btechmbss.com/admin.php";
$config['doc_url'] = "http://expressionengine.com/user_guide/";
$config['is_system_on'] = "y";
$config['allow_extensions'] = "y";
$config['site_label'] = "Chekin";
$config['cookie_prefix'] = "";

$config['enable_db_caching'] = "n";
$config['autosave_interval_seconds'] = "120";
$config['autosave_prune_hours'] = "2";
$config['cp_session_ttl'] = "18000";

...
*
* Version 4.5   -   Last Updated: February 12, 2013
*
...
(function($){
    ...
    var Plugin = function(target,options)
    {
        ...
        var opts = $.extend(
             true,               // deep extend
             {
                 ...
                 sharedesc: "Check it out", // Descrption for email to share
        ...
        $('#shareplus_close').click(function(){
    ...
    Plugin.prototype._create = function(target, opts)
    {
	   ...
	   // var meta_description = $("meta[name=description]").attr("content");
        var meta_description = opts.sharedesc ? opts.sharedesc : document.title;
	...
	if (opts.displayTitle) {
	  var title = $('<div id="shareplus_title"><div>'+ opts.title +'</div><div id="shareplus_close"><a href="javascript:void(0);" class="shareplus_close">Close</a></div></div>');
	}
